...
ceremonyType === 'burial' ? comparisonFeaturesBurial : comparisonFeaturesCremation;
...
<p className="text-sm text-gray-500 leading-relaxed px-2 md:px-4">
{pkg.description}
</p>
</div>
...
{/* Варианты гроба с фото (только для выбранного тарифа) */}
{formData.packageType === pkg.id && (
<div className="mt-6 border-t border-gray-100 pt-6">
<h4 className="mb-4 text-sm font-medium text-gray-900">
Выберите внешний вид гроба
</h4>
...
type="button"
onClick={() =>
onUpdateFormData('coffinVariant', variant.id)
}
className={cn(
...
Детальное сравнение всех включенных услуг
</p>
</div>
...
setShowDifferencesOnly(!!checked)
}
/>
<label
...
<th className="text-left p-3 sm:p-4 bg-gray-50 first:rounded-tl-2xl min-w-[140px]">
Услуга
</th>
...
([category, features], catIndex) => (
<Fragment key={category}>
<tr className="bg-gray-100">
<td
colSpan={4}
className="p-2 sm:p-3 text-xs sm:text-sm text-gray-900"
>
{category}
</td>
</tr>
