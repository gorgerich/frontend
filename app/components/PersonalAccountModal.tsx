...
const [activeTab, setActiveTab] = useState<"login" | "orders" | "settings">(
"login",
);
const [orders, setOrders] = useState<UiOrder[]>([]);
const [currentDraft, setCurrentDraft] = useState<DraftFromStorage | null>(
null,
);
...
// перерасчёт суммы и разбивки на фронте
...
{currentDraft.formData?.serviceType ===
"cremation"
? "Кремация"
: "Погребение"}
</div>
