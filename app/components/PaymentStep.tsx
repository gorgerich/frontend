...
<div className="mt-6 border-t border-white/20 pt-4">
<p className="text-xs text-white/60 mb-3">Вариант оплаты</p>
...
className={cn(
"w-full p-4 rounded-2xl border-2 transition-all duration-200 text-left bg-gray-800/50 flex items-center justify-between gap-4",
paymentOption === "full"
? "border-blue-500 bg-blue-500/20"
: "border-white/30 hover:border-white/50",
isSubmitting && "opacity-60 pointer-events-none",
...
paymentOption === "full" ? "border-blue-400" : "border-white/50",
)}
>
{paymentOption === "full" && <div className="w-2.5 h-2.5 rounded-full bg-blue-400" />}
</div>
<span className="text-sm text-white truncate">Оплатить всю сумму</span>
</div>
...
className={cn(
"w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0",
paymentOption === "deposit_5" ? "border-blue-400" : "border-white/50",
)}
>
{paymentOption === "deposit_5" && <div className="w-2.5 h-2.5 rounded-full bg-blue-400" />}
</div>
<span className="text-sm text-white truncate">Оплатить депозит (5%)</span>
</div>
<span className="text-sm text-white whitespace-nowrap">
...
className={cn(
"w-5 h-5 rounded-full border-2 flex items-center justify-center flex-shrink-0",
paymentOption === "split" ? "border-blue-400" : "border-white/50",
)}
>
{paymentOption === "split" && <div className="w-2.5 h-2.5 rounded-full bg-blue-400" />}
</div>
...
<div className="mt-2 p-4 rounded-2xl border border-white/20 bg-white/10 flex items-center justify-between">
<span className="text-sm text-white/70">К оплате сейчас</span>
